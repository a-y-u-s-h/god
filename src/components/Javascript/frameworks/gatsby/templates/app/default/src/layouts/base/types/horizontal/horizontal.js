...
export default ({ data = properties, children, strict = false, settings = properties.settings, ratio = properties["1"].height, content = properties.content, ...props }) => {
  /*
    ======================================
      Refining props.
    ======================================
  ...
  */
  ...
  options["1"].height = `${ratio}%`
  options["2"].height = `${100 - ratio}%`
  ...
  */
  return (
    <Layout display="flex" flexDirection="column" {...options["0"]}>

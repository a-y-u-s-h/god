export const triggers = (state, send) => {
  const element = {
    ...
    mouse: {
      onClick: e => e => send({ type: "mouse.over", payload: e }),
    ...
    pointer: {
      ...
      onLostPointerCapture: e =>
        send({ type: "pointer.lost.capture", payload: e }),
    ...
    media: {
      ...
      onCanPlayThrough: e =>
        send({ type: "media.can.play.through", payload: e }),
      onDurationChange: e =>
        send({ type: "media.duration.change", payload: e }),
      ...
      onLoadedMetadata: e =>
        send({ type: "media.loaded.meta.data", payload: e }),
    ...
    animation: {
      ...
      onAnimationIteration: e =>
        send({ type: "animation.iteration", payload: e })
    },
    transition: {
